...
describe('Button', () => {
  ...
  it('renders with a `primary` appearance', () => {
    const { getByTestId } = render(<Button {...defaultProps} appearance="primary" />);
    const button = getByTestId('DesignSystem-AI-Button');
  ...
  it('renders a custom className', () => {
    ...
    const { getByTestId } = render(<Button {...defaultProps} className={customClassName} />);
    const button = getByTestId('DesignSystem-AI-Button');
  ...
  it('renders button with children', () => {
    ...
    const { getByTestId } = render(<Button>{customLabel}</Button>);
    const button = getByTestId('DesignSystem-AI-Button');
