...
var Button = function (props) {
    ...
    var buttonClassNames = classNames((_a = {},
        ...
        _a), className);
    return (React.createElement("button", __assign({ className: buttonClassNames, "data-test": "DesignSystem-AI-Button" }, rest), label || children));
};
Button.defaultProps = {
    appearance: 'basic'
};
...
var IconButton = function (props) {
    ...
    var buttonClassNames = classNames((_a = {},
        ...
        _a), className);
    return (React.createElement("button", __assign({ className: buttonClassNames, "data-test": "DesignSystem-AI-IconButton" }, rest),
        icon,
        "aa"));
};
...
var Avatar = function (props) {
    ...
    return (React.createElement("img", __assign({ src: img, alt: alt, width: avatarWidth, height: avatarHeight, "data-test": "DesignSystem-AI-Avatar" }, rest)));
};
Avatar.defaultProps = {
    width: 32,
    height: 32,
...
var Text = function (props) {
    ...
    var TextClassNames = classNames((_a = {},
        _a[styles.Text] = true,
        _a), className);
    return (React.createElement("span", __assign({ "data-test": "DesignSystem-AI-Text", className: TextClassNames }, rest), children));
};

export { Avatar, Button, IconButton, Text };
